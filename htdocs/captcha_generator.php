...
//  code script if from https://www.abeautifulsite.net/a-simple-php-captcha-script
//
function simple_php_captcha($config = array()) {
    ...
    $bg_path = dirname(__FILE__) . '/captcha_backgrounds/';
    $font_path = dirname(__FILE__) . '/captcha_fonts/';
    ...
    $captcha_config = array(
        ...
        'max_length' => 5,
        'backgrounds' => array(
            $bg_path . 'captcha_background.png'
        ),
        'fonts' => array(
