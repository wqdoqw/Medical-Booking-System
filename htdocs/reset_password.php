                ...
                <div id="mainContent" class="container-fluid">
                    ...
                    <div class="reset_password">
                        <form method="POST" action="dbconnection/reset_process.php" onsubmit="return checkFromValidation()">
                            ...
                            <input id="newPassword" name="new_Password" type="password" minlength="6" maxlength="20"
                             class="l-form-username form-control" placeholder="your new password" required>
                            <br>
                            <label class="conform_password" for="new_password" >Confirm Password:</label>&nbsp;
                            <input id="confirmPassword" name="confirm_Password" type="password" minlength="6" maxlength="20" 
                             class="l-form-username form-control" placeholder="confirm your new password" required>
